...
class CryptoService {
  ...
  String hashPassword(String password, String salt) =>
      sha256.convert(utf8.encode('$salt::$password::$_pepper')).toString();
  String newSalt([String seed = '']) => sha256
      .convert(utf8.encode('${DateTime.now().microsecondsSinceEpoch}::$seed'))
      .toString()
      .substring(0, 32);
