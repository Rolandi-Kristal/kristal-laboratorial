...
class EquipamentosScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    KristalModuleField(key: 'nome', label: 'Nome do equipamento', icon: Icons.precision_manufacturing_rounded, maxLines: 1, required: true),
    KristalModuleField(key: 'setor', label: 'Setor', icon: Icons.domain_rounded, maxLines: 1, required: true),
    KristalModuleField(key: 'ip', label: 'IP', icon: Icons.router_rounded, maxLines: 1, required: true),
