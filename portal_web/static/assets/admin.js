...
function mostrarPainel() {
  ...
  localStorage.removeItem('kristalServerApiKey');
  serverApiKey.value = '';
...
document.getElementById('salvarServerApiKeyBtn').addEventListener('click', () => { const value = serverApiKey.value.trim(); if (!value) { serverMsg.textContent = 'Informe a chave API do servidor.'; return; } serverMsg.textContent = 'Chave disponível somente nesta sessão e não persistida no navegador.'; });
